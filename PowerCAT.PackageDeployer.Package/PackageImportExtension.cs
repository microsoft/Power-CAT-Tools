...
namespace PowerCAT.PackageDeployer.Package
{
    ...
    public class PackageImportExtension : ImportExtension
    {
        ...
        public override string GetNameOfImport(bool plural) => "power-cAT-dataverse-accelerator";

        /// <summary>
        /// Long name of the Import Package.
        /// </summary>
        public override string GetLongNameOfImport => "power-cAT-dataverse-accelerator";

        /// <summary>
        /// Description of the package, used in the package selection UI
        /// </summary>
        public override string GetImportPackageDescriptionText => "power-cAT-dataverse-accelerator";
